...
from ..core.remove_join import RemoveAttributeLayerJoin
...
class GuiManager(QObject):
    ...
    def __init__(self, iface, parentMenu=None, toolbar=None):
        ...
        self.iconBasePath = ':/plugins/thematic_map_tools/icons/'
        self.actions = []
        self.managerList = []
        self.menuList = []
    ...
    def instantiateManagers(self):
        self.remove_attribute_joins = RemoveAttributeLayerJoin(self, self.iface, parentMenu=self.menu, toolbar=self.toolbar)
        self.managerList.append(self.remove_attribute_joins)

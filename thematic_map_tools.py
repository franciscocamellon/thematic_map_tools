...
class ThematicMapTools(object):
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ThematicMapTools_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Thematic Map Tools')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ThematicMapTools', message)
    ...
    def initGui(self):
        ...
        self.toolbar = self.iface.addToolBar(self.tr(u'&Thematic Map Tools'))
